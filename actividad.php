...
<head>
    ...
    <!-- ========== SEO ========== -->
    <title>Hospedería de Alesves - Actividad</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img src="images/hospederia-de-alesves.gif" height="74" alt="Logo" style="position: relative;top:-30px;">
                    </a>
                </div>
                <nav id="main_menu" class="mobile_menu navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown simple_menu active"><a href="#" data-toggle="dropdown" class="dropdown-toggle" aria-expanded="true">RESTAURACIÓN <b class="caret"></b></a></li>
                        <li class="dropdown simple_menu"><a href="banners.php" data-toggle="dropdown" class="dropdown-toggle" aria-expanded="true">ACTIVIDADES<b class="caret"></b></a></li>
            ...
            <div class="container">
                <div class="inner">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="banners.php">ACTIVIDADES</a></li>
        ...
        <main>
            <div class="container">
                <img src="images/monolito.jpg" class="img-responsive br2 mb20" alt="Image">
                <p>Lugar de obligada visita y de actividades diversas como: SENDERISMO, para los amantes de la naturaleza, RUTAS EN BICICLETA (BTT) para los deportistas que quieren visitar un entorno natural y RUTAS EN 4X4 si lo que nos interesa es el paisaje y el entorno con facilidad de desplazamiento. Tambien pueden realizarse PASEOS A CABALLO o en QUAD.</p>
                <p>Este parque natural, recientemente declarado por la UNESCO Reserva de la Biosfera lo podemos dividir en tres partes: Bardena Baja, Bardena Blanca y El Plano.</p>
                <div class="row image-gallery">
                    <!-- ITEM -->
                    <div class="col-md-3 col-sm-6 mt20 mb20">
                        <a href="images/places/place1.jpg">
                            <img src="images/breales.png" height="30" class="img-responsive full_width br2" alt="Localizacion bardenas reales">
                        </a>
                    </div>
                    <!-- ITEM -->
                    <div class="col-md-3 col-sm-6 mt20 mb20">
                        <a href="images/places/place5.jpg">
                            <img src="images/monolito.jpg" class="img-responsive full_width br2" alt="Image">
                        </a>
                    </div>
                    <!-- ITEM -->
                    <div class="col-md-3 col-sm-6 mt20 mb20">
                        <a href="images/places/place3.jpg">
                            <img src="images/bardenas.jpg" hieght="30" class="img-responsive full_width br2" alt="Image">
                        </a>
                    </div>
                    <!-- ITEM -->
                    <div class="col-md-3 col-sm-6 mt20 mb20">
                        <a href="images/places/place4.jpg">
                            <img src="images/brealess.jpg" class="img-responsive full_width br2" alt="Image">
                        </a>
                    </div>
                </div>
                <p>Destacamos las innumerables formas caprichosas formadas a lo largo del tiempo gracias a la actividad erosiva de los suelos. Dentro del desierto encontramos el contraste de la humedad formada por diversas balsas. Este hermoso paraje natural también acoge en su interior aves, vegetación y animales.</p>
                <blockquote>
                    <i class="fa fa-quote-left"></i>
                    <span class="quote_text">Para más información visite la web oficial de <a href="https://bardenasreales.es/">Las Bardenas Reales</a></span>
                </blockquote>
            </div>
        </main>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-6 widget">
                            <div class="about">
                                <a href="index.html"><img class="logo" height="80" src="images/hospederia-de-alesves.gif" height="32" alt="Logo"></a>
                        ...
                        <div class="col-md-3 col-sm-6 widget">
                            ...
                            <address>
                                <ul class="address_details">
                                        ...
                                        <li><i class="glyphicon glyphicon-phone-alt"></i>Teléfono: <a href="tel:948845686">(+34) 948 84 56 86</li>
