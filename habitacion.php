            ...
            <div class="container">
                ...
                <nav id="main_menu" class="mobile_menu navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown simple_menu"><a href="banners.php" data-toggle="dropdown" class="dropdown-toggle" aria-expanded="true">ACTIVIDADES<b class="caret"></b></a>
                        </li>   
                        <li><a href="contacto.php">CONTACTO</a></li>
                        <li class="menu_button">
                            <a href="bookin.php" class="button  btn_yellow"><i class="fa fa-calendar"></i>BOOK ONLINE</a>
                        </li>
                    </ul>
                </nav>
            </div>
                ...
                <div class="inner">
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <h1>Habitación <?php echo $_GET['tipo']; ?></h1>
                            <ol class="breadcrumb">
                                <li><a href="index.html">Inicio</a></li>
                                <li>Alojamiento</li>
                                <li>Habitacion <?php echo $_GET['tipo']; ?></li>
                            </ol>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <div class="price">
                                <div class="inner">
                                    <?php echo $precio;?>€<span>/ noche</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <p><?php if($_GET['tipo']=='trabajadores'){echo'Incluye habitación doble de uso individual, desayuno y cena. <b>Válido de lunes a jueves no festivos</b><br><br>';} ?>
                            Nuestras once habitaciones, sorprenden por su atractivo diseño, funcionalidad y ambiente acogedor. Todas ellas conservan sus altos techos de madera y sus grandes y abocinados ventanales, que se asoman al jardín.
                            Están   dotadas de:
                        ...
                        <div class="main_title t_style a_left s_title mt50">
                            <div class="c_inner">
                                <h2 class="c_title">Servicios de la habitación:</h2>
                            </div>
                        </div>
                            ...
                            <div class="all_facility_list">
                                <div class="col-sm-4 nopadding">
                                    <ul class="list-unstyled">
                                        <li><i class="fa fa-check"></i>Cama doble</li>
                                        <li><i class="fa fa-check"></i>60m<sup>2</sup></li>
                                        <li><i class="fa fa-check"></i>Capacidad para hasta 4 personas</li>
                                        <li><i class="fa fa-check"></i>Internet gratuito</li>
                                    </ul>
                                </div>
                                <div class="col-sm-4 nopadding">
                                    <ul class="list-unstyled">
                                        <li><i class="fa fa-check"></i>Televisión</li>
                                        <li class="no"><i class="fa fa-times"></i>Desayuno</li>
                                        <li><i class="fa fa-check"></i>Aire acondicionado</li>
                                        <li class="no"><i class="fa fa-check"></i>Vistas al jardín</li>
                                    </ul>
                                </div>                               
                            </div>
                        </div>
                        <div class="similar_rooms">
                            <div class="main_title t_style5 l_blue s_title a_left">
                                <div class="c_inner">
                                    <h2 class="c_title">HABITACIONES SIMILARES</h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <article>
                                        <figure>
                                            ...
                                            <div class="price"><?php echo $precio2;?>€<span>/ noche</span></div>
                                            <figcaption>
                                ...
                                <div class="col-md-4">
                                    <article>
                                        <figure>
                                            ...
                                            <div class="price"><?php echo $precio3;?>€<span>/ noche</span></div>
                                            <figcaption>
                                ...
                                <div class="col-md-4">
                                    <article>
                                        <figure>
                                            ...
                                            <div class="price"><?php echo $precio4;?>€<span>/ noche</span></div>
                                            <figcaption>
                    ...
                    <div class="col-md-4">
                        <div class="sidebar">
                            <aside class="widget">
                                <div class="vbf">
                                    <h2 class="form_title"><i class="fa fa-calendar"></i>REALIZA TU RESERVA</h2>
                                    <form id="booking-form" class="inner">
                                        ...
                                        <div class="form-group">
                                            <div class="form_select">
                                                <select name="booking-roomtype" class="form-control" title="Selecione tipo de habitación:" data-header="Habitación:" disabled>
                                                    <option value="Individual" <?php if($_GET['tipo']=='individual') echo'selected'; ?>>Individual</option>
                                                    <option value="Doble" <?php if($_GET['tipo']=='doble') echo'selected'; ?>>Doble</option>
                                                    <option value="Superior" <?php if($_GET['tipo']=='superior') echo'selected'; ?>>Superior</option>
                                                    <option value="Triple" <?php if($_GET['tipo']=='triple') echo'selected'; ?>>Triple</option>
                                                    <option value="Familiar" <?php if($_GET['tipo']=='familiar') echo'selected'; ?>>Familiar</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12 nopadding">
                                            <div class="form_select">
                                                <select name="booking-adults" class="form-control md_noborder_right" title="Adultos:" data-header="Adultos:">
                                        ...
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12 nopadding">
                                            <div class="form_select">
                                                <select name="booking-children" class="form-control" title="Niños:" data-header="Niños:">
                                                    <option value="0">0</option>
                                                    <option value="1">1</option>
                                                    <option value="2">2</option>
                                                    <option value="3">3</option>
                                        ...
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12 nopadding">
                                            <div class="input-group">
                                                <div class="form_date">
                                                    <input type="text" class="datepicker form-control md_noborder_right" name="booking-checkin" placeholder="Fecha de llegada:" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12 nopadding">
                                            <div class="input-group">
                                                <div class="form_date">
                                                    <input type="text" class="datepicker form-control" name="booking-checkout" placeholder="Fecha de salida:" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <button class="button btn_lg btn_blue btn_full" type="submit">RESERVAR HABITACIÓN</button>
                                        <div class="a_center mt10">
                                            <a href="bookin.php" class="a_b_f">Reserva detallada</a>
                                        </div>
                                    </form>
                                </div>
                            </aside>
                            <aside class="widget">
                                ...
                                <div class="help">
                                    Si tienes cualquier tipo de problema no dudes en ponerte en contacto con nostros. Haremos todo lo que esté en nuestras manos para ayudarte.
                            ...
                            <aside class="widget">
                                ...
                                <div class="latest_posts">
                                    ...
                                    <article class="latest_post">
                                        ...
                                        <div class="details">
                                            <h6><a href="blog-post.html">Reserva para comidas o cenas por encargo.</a></h6>
                                    ...
                                    <article class="latest_post">
                                        ...
                                        <div class="details">
                                            <h6><a href="blog-post.html">Consulta nuestras ofertas en alojamiento</a></h6>
                                    ...
                                    <article class="latest_post">
                                        ...
                                        <div class="details">
                                            <h6><a href="blog-post.html">Contamos con alquiler de bicicletas</a></h6>
                                            <span><i class="fa fa-calendar"></i>13/08/2017</span>
                                        </div>
                                    </article>
                                    <article class="latest_post">
                                        ...
                                        <div class="details">
                                            <h6><a href="blog-post.html">Descubre las Bardenas Reales</a></h6>
                                    ...
                                    <article class="latest_post">
                                        ...
                                        <div class="details">
                                            <h6><a href="blog-post.html">Visita el Castillo de Olite</a></h6>
                                            <span><i class="fa fa-calendar"></i>13/08/2017</span>
                                        </div>
                                    </article>
                                    <article class="latest_post">
                                        ...
                                        <div class="details">
                                            <h6><a href="blog-post.html">Saborea lo mejor de la Ribera</a></h6>
                                            <span><i class="fa fa-calendar"></i>13/08/2017</span>
                                        </div>
                                    </article>
                                </div>
