...
<head>
    ...
    <!-- ========== SEO ========== -->
    <title>Hospedería de Alesves - Oferta 3 noches</title>
...
<body>
    ...
    <div id="smoothpage" class="wrapper">
                ...
                <nav id="main_menu" class="mobile_menu navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu_button">
                            <a href="booking-form.html" class="button  btn_yellow"><i class="fa fa-calendar"></i>RESERVAR</a>
                        </li>
                    </ul>
                </nav>
            </div>
        ...
        <div class="page_title gradient_overlay" style="background: url(images/hospederia.jpg)bottom right no-repeat,url(images/06_exterior.jpg) center no-repeat,url(images/jardin_1.jpg) center repeat;">
            <div class="container">
                <div class="inner">
                    <h1>Oferta tres noches</h1>
                    <ol class="breadcrumb">
                        <li><a href="index.html">Inicio</a></li>
                        <li>Oferta tres noches</li>
                    </ol>
                </div>
            </div>
        </div> 
                ...
                <div class="col-md-6 col-sm-6">
                    <article class="room_block_item">
                       <div class="row">
                          ...
                          <div class="col-lg-6 col-md-12">
                             <div class="room_info">
                                <h3><a href="habitacion?tipo=doble">Doble</a></h3>
                                <span>61€ / noche</span>
                                <p>Habitación doble con descuento si la estancia supera las tres noches.</p>
                                <div class="room_services">
                                   <i class="fa fa-coffee" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Desayuno incluido" data-original-title="Desayuno"></i> 
                                   <i class="fa fa-cutlery" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Minibar" data-original-title="Minibar"></i> 
                                   <i class="fa fa-wifi" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="WiFi gratuito" data-original-title="WiFi gratuito"></i>
                                   <i class="fa fa-television" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="TV de plasma" data-original-title="TV de plasma"></i>                              
                                </div>
                             </div>
                              <span class="f_right"><a href="bookin.php?tipo=dobleOferta" class="button btn_sm btn_blue">RESERVAR</a></span>
                          </div>
                       </div>
                    </article>
                </div>
                ...
                <div class="col-md-6 col-sm-6">
                    <article class="room_block_item">
                       <div class="row">
                          ...
                          <div class="col-lg-6 col-md-12">
                             <div class="room_info">
                                <h3><a href="habitacion.php?tipo=triple">Triple</a></h3>
                                <span>79€ / noche</span>
                                <p>Habitación individual con descuento si la estancia supera las tres noches.</p>
                                <div class="room_services">
                                   <i class="fa fa-coffee" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Desayuno incluido" data-original-title="Desayuno"></i> 
                                   <i class="fa fa-cutlery" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Minibar" data-original-title="Minibar"></i> 
                                   <i class="fa fa-wifi" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="WiFi gratuito" data-original-title="WiFi gratuito"></i>
                              ...
                              <span class="f_right"><a href="bookin.php?tipo=tripleOferta" class="button btn_sm btn_blue">RESERVAR</a></span>
                          </div>
                       </div>
                    </article>
                </div>
                ...
                <div class="col-md-6 col-sm-6">
                    <article class="room_block_item">
                       <div class="row">
                          ...
                          <div class="col-lg-6 col-md-12">
                             <div class="room_info">
                                <h3><a href="habitacion.php?tipo=familiar">Familiar</a></h3>
                                <span>106€ / noche</span>
                                <p>Habitación individual con descuento si la estancia supera las tres noches.</p>
                                <div class="room_services">
                                   <i class="fa fa-coffee" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="Desayuno incluido" data-original-title="Desayuno"></i> 
                              ...
                              <span class="f_right"><a href="bookin.php?tipo=familiarOferta" class="button btn_sm btn_blue">RESERVAR</a></span>
                          </div>
                       </div>
                    </article>
                </div>
